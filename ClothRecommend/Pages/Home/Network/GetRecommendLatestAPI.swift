...
struct GetRecommendLatestAPI {
    static let scheme = "http://"
    static let host = "43.201.140.61:55607"
    static let path = "/api/v1/main/recomm/user"
    
    func getapi() -> String {
        var urlStr = GetRecommendLatestAPI.scheme + GetRecommendLatestAPI.host + GetRecommendLatestAPI.path
