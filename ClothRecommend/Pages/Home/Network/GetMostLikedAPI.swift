...
struct GetMostLikedAPI {
    static let scheme = "http://"
    static let host = "43.201.140.61:55607"
    static let path = "/api/v1/main/recomm/best"
    
    func getapi() -> String {
        var urlStr = GetMostLikedAPI.scheme + GetMostLikedAPI.host + GetMostLikedAPI.path
